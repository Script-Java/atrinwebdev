// Create a new file for this component, e.g., in a 'components' folder.
...
export default function AllenPageClient() {
  // All your existing page content, data arrays, and JSX go here.
  const allenServices = [
    {
